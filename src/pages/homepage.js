    ...
    <div className="relative">
      <div className="h-56 sm:h-64 xl:h-80 2xl:h-96 relative z-0 mt-16"> {/* Set a lower z-index for the carousel */}
        <Carousel slideInterval={5000} theme={{
          ...
          <img src="../assets/image3.png" alt="..." style={{ width: '100%', height: '200%' }} />
          <img src="../assets/image2.jpg" alt="..." style={{ width: '100%', height: '200%' }} />
          <img src="../assets/image1.jpeg" alt="..." style={{ width: '100%', height: '200%' }} />
        </Carousel>
      </div>
