  ...
  return (
    <div
      ...
      <div className="mb-5 mt-6 flex flex-col items-center justify-center gap-2">
        ...
        <h3 className="text-[18px] text-secondary font-[600]">
        ...
        {menuItems.map((item, i) => {
          return (
            <div key={i}>
                ...
                <span
                  className={
                    location.pathname == item.path
                      ...
                      : "body1  font-[700] mr-3 text-secondary"
                  }>
                  {item.name}
                </span>
                {item.path == "" ? (
              ...
              {dropdown.name == item.name || localItem == item.name ? (
                <div className="w-[90%]">
                  {
                    <ul>
                          ...
                          <li
                            ...
                            <button
                              ...
                              <span
                                className={
                                  location.pathname == d.path
                                    ? " text-primary font-[700] flex items-center gap-3"
                                    : "body1 text-main mr-3"
                                }>
                                <span>
                                  {location.pathname == d.path ? item.icon : ""}
                                </span>{" "}
                                {d.name}
                              </span>
                            </button>
